...
# Use All-area coordinates to reduce accumulating error: [only need to adjust astigmatism once at the beginning]
# Calibration: C(0,0)=(0,0) A(900,0)=(4040,0) G(900,900)=(4040,4040)
# Reduce accumulating error:
#   guess Local Origin -> move cursor to Real Local Origin -> read out coordinates of Real Local Origin
# Guess Local Origin [All-area coord.]
# A: 3140 0
# B: 1570 0
# C: 0 0
# D: 3140 1570
...
# H: 1570 3140
# I: 0 3140
# Example: (default writing field)
#   Area: Writing Field [Global coord.], WFSP [Local coord.] (= 50 - margin, used for autopatch program),
#         Guess Local Origin [All-area coord.] (used for local origin guess),
#         Input WFSP [All-area coord.] (= Real Local Origin + 50 - margin)
# A: 3670 530 4870 1730, -100 -100,
#    3140 0, (3140.XXX 0.XXX)+(-100 -100)

# patch all areas
insfile=""

python3 patchedges_svg.py -s -50 -50 drawing_AreaA_Lined.svg > drawing_AreaA_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaB_Lined.svg > drawing_AreaB_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaC_Lined.svg > drawing_AreaC_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaD_Lined.svg > drawing_AreaD_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaE_Lined.svg > drawing_AreaE_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaF_Lined.svg > drawing_AreaF_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaG_Lined.svg > drawing_AreaG_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaH_Lined.svg > drawing_AreaH_Patches.svg.cache
...
python3 patchedges_svg.py -s -50 -50 drawing_AreaI_Lined.svg > drawing_AreaI_Patches.svg.cache
